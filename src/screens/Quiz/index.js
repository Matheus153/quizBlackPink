...
import correctAnim from './animations/correctAnim.json';
import incorrectAnim from './animations/incorrectAnim.json';
import loadingAnimation from './animations/loadpink.json';
  ...
  return (
    ...
    animate="show">
      ...
      <h5 style= {{
          ...
          { score >= 7 && `Boa ${name}, você é realmente fera quando o assunto é Black Pink e com certeza é um Blink! Parabéns!! :)`}
          { score > 4 && score < 7 && `Ehh... você o conhece, mas não o suficiente para ser parte do Fandom. Talvez na próxima se dê melhor! :)`}
          {score <= 4 && score > 1 && `É... você não foi bem. Somente ${score} acertos. Espero que consiga na próxima :)`}
          {score <= 1 && `Essa foi péssima hein, tomara que melhore bastante na próxim! Sorte na próxima! :)`}
